...
/**
* compteur permet l'initialisation du numero du processus
* numDestruct permet de terminer le programme de manière propre
**/
struct manip{
    int cptrProcess;
};
...
struct recept{
    int socket;
    struct sockaddr * addrServeur;
    struct message *  messageReception;
};
